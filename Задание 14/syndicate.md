...
### 1. Создаем начальную популяцию из 4 случайных особей, рассчитываем вес взятых предметов и фитнес-функцию
...
## Набор предметов, обеспечивающих максимальную стоимость - **A, B, E**.
## Общий вес предметов в рюкзаке - **15**.
## Свободное место в рюкзаке - **0**.

Полученное решение совпадает с точным.