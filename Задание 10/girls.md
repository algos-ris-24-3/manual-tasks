...
В остаточной сети не найдено увеличивающих путей, следовательно, алгоритм завершил работу и найденный поток величиной 16 является максимальным для данной сети, так как сумма потока, выходящего из источника равна 16, и суммарный поток, входящий в сток, равен 16.
![image](https://github.com/KhudyakovaSvetlana/images/blob/main/16.jpeg)
