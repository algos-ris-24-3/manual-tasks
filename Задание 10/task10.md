...
| 2 | s, a                            | b, c, t       |       7 + 3 + 6 = 16           |
| 3 | s, b                            | a, c, t       |       8 + 2 + 5 = 15           |
| 4 | s, c                            | a, b, t       |         8 + 5 + 5 = 18         |
|   | **s + пара вершин из a, b, c**  |               |                                |
| 5 | s, a, b                         | c, t          |         6 + 5 + 2 = 13         |
| 6 | s, a, c                         | b, t          |         7 + 3 + 5 = 15         |
| 7 | s, b, c                         | a, t          |         8 + 5 + 2 = 15         |
|   | **s + три вершины из a, b, c**  |               |                                |
| 8 | s, a, b, c                      | t             |         7 + 2 + 5 = 14         |

Минимальная пропускная способность разреза равна 13 ( {s} / {a, b, c, t} и {s, a, b} / {c, t} ), что совпадает с найденной величиной максимального потока в сети.
