...
![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11-7.jpg)
...
![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11-8.jpg)
...
![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11-9.jpg)
...
![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11(2)%20-%201.jpeg)

В остаточной сети найден ориентированный цикл отрицательной стоимости s -> b -> c -> d -> s (- 3 - 3 + 1 + 4 = -1). 

![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11(2)%20-%202.jpeg)

Найдем минимальный вес ребра в указанном цикле, изображенном **в остаточной сети с указанием величины потока**.  

![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11(2)%20-%204.jpeg)

Минимальный вес ребра в цикле 2 - это неиспользованный резерв ребра c -> d.

Удалим найденный цикл - уменьшим на 2 вес всех ребер, входящих в цикл.

![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11(3)%20-%201.jpeg)

Скорректируем остаточную сеть с указанием стоимости транспортировки единицы потока.

![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11(2)%20-%203.jpeg)
...
![image](https://github.com/KhudyakovaSvetlana/images/blob/main/11(3)%20-%202.jpeg)
