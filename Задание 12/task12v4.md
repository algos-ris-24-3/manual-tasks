...
Самая перспективная вершина — **2** (оценка 62). Продолжаем из неё, рассматриваем предмет **D**.
...
Самая перспективная вершина — **6** (оценка 43). Продолжаем из неё, рассматриваем предмет **B**.

**Левый потомок (−A+D+B):** берём D+B (вес=3+4=7, стоимость=9+8=17), не берём A, остаток=13, заполняем E (ценность=0,5):

$$
17 + 13 \times 0,5 = 17 + 6,5 = 23,5
$$

**Правый потомок (−A+D−B):** берём D (вес=3, стоимость=9), не берём A, не берём B, остаток=17, заполняем E (ценность=0,5):

$$
9 + 17 \times 0,5 = 9 + 8,5 = 17,5
$$
...
Самая перспективная вершина — **7** (оценка 40). Продолжаем из неё, рассматриваем предмет **B**.

**Левый потомок (−A−D+B):** берём B (вес=4, стоимость=8), не берём A, не берём D, остаток=16, заполняем E (ценность=0,5):

$$
8 + 16 \times 0,5 = 8 + 8 = 16
$$

**Правый потомок (−A−D−B):** не берём A, D, B, остаток=20, заполняем E (ценность=0,5):
...
Самая перспективная вершина — **16** (оценка 30,25). Продолжаем из неё, рассматриваем последний предмет **C**.
...
Поскольку мы опустились до самого нижнего уровня (рассмотрели все предметы) и вершина **19** на самом нижнем уровне является самой перспективной среди всех нераскрытых вершин (30 > 27,75 > 24,5 > 23,5 > ...), то это и будет ответом.

Чтобы восстановить все положенные в рюкзак предметы пройдемся по рёбрам, которые привели нас к вершине **19**:
- **+A** → берём A
- **+D** → берём D
- **+B** → берём B
- **+E** → берём E
