...
В ячейке C3 появилось новое нулевое значение
...
Все вершины покрыты, значит задача решена. Минимальные назначения: [A5] [B2] [C4] [D1] [E3]. Минимальная стоимость: 8+10+7+5+9 = 39
